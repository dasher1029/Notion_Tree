...
## 1. Purpose
This application is designed to visualize your Notion workspace structure using the official Notion API.  
It is intended for personal and educational use.
